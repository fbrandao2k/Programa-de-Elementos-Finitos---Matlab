...
set(gcf,'name','Problem 3 - Hole in a plate','numbertitle','off') ;
...
% handles    structure with handles and user data (see GUIDATA)
    ...
    n = str2double ( get(handles.nElem,'String') ); %Number of elements optimization
    ...
    Plot2DMesh2(handles.nodcoor, handles.elenod, handles.elemat, handles.nodetag,handles.forcevalues, P);
...
if strcmp(handles.mode,'SOLVED_MODE') == 0 && strcmp(handles.mode,'CHANGED_MODE') == 0
    ...
    PlotDeformedMesh2(handles.nodcoor, handles.elenod,handles.elemat, 1e-10, handles.solution.noddisplacement);
end
...
if strcmp(handles.mode,'SOLVED_MODE') == 0
    ...
    axis equal
    cla;
    PlotResult2(handles.nodcoor, handles.elenod,handles.elemat, 1, handles.solution.noddisplacement(:,1), 'UX');
...
if strcmp(handles.mode,'SOLVED_MODE') == 0
    ...
    axis equal
    cla;
    PlotResult2(handles.nodcoor, handles.elenod,handles.elemat, 1, handles.solution.noddisplacement(:,2), 'UY');
    handles.mode='CHANGED_MODE';
end
...
if strcmp(handles.mode,'SOLVED_MODE') == 0
    ...
    PlotResult2(handles.nodcoor, handles.elenod,handles.elemat, 1, nodeStresses', 'sigmaXX');
    handles.mode='CHANGED_MODE';
end
...
if strcmp(handles.mode,'SOLVED_MODE') == 0
    ...
    PlotResult2(handles.nodcoor, handles.elenod,handles.elemat, 1, nodeStresses', 'sigmaYY');
    handles.mode='CHANGED_MODE';
end
...
if strcmp(handles.mode,'SOLVED_MODE') == 0
    ...
    PlotResult2(handles.nodcoor, handles.elenod,handles.elemat, 1, nodeStresses', 'sigmaXY');
    handles.mode='CHANGED_MODE';
end
